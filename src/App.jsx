...
export default function App() {
  ...
  return (
    // <div className="relative min-h-screen pb-24 bg-sys-bg text-sys-on-surface transition-colors duration-1000 overflow-hidden font-sans">
    //   {/* MASSIVE AMBIENT BACKGROUND ANIMATIONS */}
    ...
    //   <main
    //     id="top"
    //     className="relative z-10 container mx-auto px-6 pt-32 space-y-32 min-h-screen"
    //   >
